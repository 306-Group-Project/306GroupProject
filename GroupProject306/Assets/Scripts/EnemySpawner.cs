	...
	private void SpawnEnemy()
	{
		...
		if (Time.time > spawnTimer)
		{
			...
			if (levelManager.GetComponent<LevelSystem>().spawnerStatus())
			{
				if (levelManager.GetComponent<LevelSystem>().getLevel() <= 2)
				{
				...
				} else if (levelManager.GetComponent<LevelSystem>().getLevel() > 2 &&
				          levelManager.GetComponent<LevelSystem>().getLevel() <= 5)
					...
					} else if (levelManager.GetComponent<LevelSystem>().getLevel() > 5 &&
					           levelManager.GetComponent<LevelSystem>().getLevel() <= 8)
				{
					float rand = Random.Range(0, 10);
					if (rand < 4)
					{
